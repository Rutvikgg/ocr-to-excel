...
def open():
    ...
    path_label = Label(frame, text=root.filename, borderwidth=2, relief="solid").grid(row=0, column=0, columnspan=2,
                                                                                      padx=5, pady=5)
...
path_label = Label(frame, text=root.filename, borderwidth=2, relief="solid").grid(row=0, column=0, columnspan=2, padx=5,
                                                                                  pady=5)
